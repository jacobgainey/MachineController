...
{
    public static class GCodeDictionary
    {
        public static readonly Dictionary<string, string> Commands = new()
        {
            ...
            { "G34", "Mechanical Gantry Calibration or Z Steppers Auto-Alignment" },
            ...
            { "M665", "Delta Configuration or SCARA Configuration" },
            { "M666", "Set Delta endstop adjustments or Set dual endstop offsets" },
        ...
        public static string GetDescription(string gcode)
        {
            return Commands.TryGetValue(gcode.ToUpper(), out var description)
                ? description
                : "Unknown G-Code";
        }
    }
